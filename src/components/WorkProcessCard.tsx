import BounceElementWrapper from "../animations/BounceElementWrapper";
...
export default function WorkProcessCard({
  ...
  return (
    <>
      <BounceElementWrapper>
        <article>
          <div
            className={`${
              id == 1
                ? "bg-lime-300 rotate-6 transition-transform duration-100 hover:bg-lime-400 hover:rotate-0"
